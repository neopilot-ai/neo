...
Let's start with the obvious. NEO v3 moves away from CloudFormation and CDK, [we've written in detail about why we decided to do this](https://neo.dev/blog/moving-away-from-cdk.html).
...
1. Create a new account on the Console — <a href={config.console}>console.neo.dev</a>
...
In v2, some modules in the Node client had [handlers and hooks](https://v2.neo.dev/clients#handlers).
