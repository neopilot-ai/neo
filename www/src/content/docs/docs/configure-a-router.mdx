...
// Docs
const docs = new neo.aws.Astro("MyDocs", {
  path: "packages/docs"
});
```
...
The `A2WQRGCYGTFB7Z` is the ID of the Router distribution created in the dev stage. You can look this up in the NEO Console or output it when you deploy your dev stage.
