...
1. Follow this to [create an IAM user](https://neo.dev/chapters/create-an-iam-user.html)
2. And then use this to [configure the credentials](https://neo.dev/chapters/configure-the-aws-cli.html)
