...
Below is a collection of example NEO apps. These are available in the [`examples/`](https://github.com/neopilot-ai/neo/tree/dev/examples) directory of the repo.
...
#### Contributing
To contribute an example or to edit one, submit a PR to the [repo](https://github.com/neopilot-ai/neo).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-apig-auth).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-astro-redis).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-astro-stream).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-aurora-local).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-aurora-mysql).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-aurora-postgres).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-auth-react).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-bucket-policy).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-bucket-queue-subscriber).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-bucket-subscriber).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-bucket-topic-subscriber).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-bun-elysia).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-bun-redis).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-cluster-autoscaling).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-cluster-internal).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-cluster-spot).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-cluster-vpclink).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-dead-letter-queue).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-deno-redis).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-drizzle-migrations).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-dynamo).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-ec2-pulumi).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-efs-sqlite).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-efs-surrealdb).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-efs).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-express-redis).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-ffmpeg).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-go-api-gateway-v2).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-go-lambda-bucket-presigned-url).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-go-lambda-dynamo).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-hono-redis).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-hono-steam).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-iam-permission-boundary).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-info).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-jsx-email).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-kinesis-stream).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-lambda-golang).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-lambda-hook).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-lambda-retry-with-queues).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-lambda-rust-multiple-binaries).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-lambda-stream).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-lambda-vpc).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-multi-region).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-mysql-local).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-mysql).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-nestjs-redis).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-nextjs-add-behavior).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-nextjs-basic-auth).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-nextjs-redis).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-nextjs-stream).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-open-search-local).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-open-search).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-postgres-local).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-prisma-lambda).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-puppeteer).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-python-container).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-python-huggingface).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-python).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-queue).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-redis-local).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-remix-redis).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-remix-stream).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-router-bucket).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-router).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-service-discovery).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-sharp).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-solid-container-ws).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-static-site-basic-auth).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-static-site).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-svelte-redis).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-swift).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-t3).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-task-cron).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-task).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-topic).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-vector).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-vite).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/cloudflare-cron).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/cloudflare-kv).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/secret-link-all).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/neo-$transform).
...
View the [full example](https://github.com/neopilot-ai/neo/tree/dev/examples/vercel-domain).
