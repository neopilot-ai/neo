...
The Console is a web based dashboard to manage your NEO apps — [**console.neo.dev**](https://console.neo.dev)
...
<a href="https://console.neo.dev" target="_blank" rel="noopener noreferrer">
  <picture>
...
1. **Create an account with your email**
   ...
   It's better to use your work email so that you can invite your team to your workspace later — [**console.neo.dev**](https://console.neo.dev)
...
↗  Permalink  https://neo.dev/u/318d3879 
```
...
:::info
The local server only allows access from `localhost` and `console.neo.dev`.
:::
...
[contact-us]: mailto:hello@neo.dev
