---
title: Next.js on AWS with NEO
description: Create and deploy a Next.js app to AWS with NEO.
---
...
import consoleAutodeploy from "../../../../../assets/docs/start/neo-console-autodeploy.png"

There are two ways to deploy a Next.js app to AWS with NEO.
...
:::tip[View source]
You can [view the source](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-nextjs) of this example in our repo.
:::
...
Run the following to start dev mode. This'll start NEO and your Next.js app.
...
<Image src={nextApp} alt="NEO Next.js app local" />
...
:::tip[View source]
You can [view the source](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-nextjs-container) of this example in our repo.
:::
...
To deploy our Next.js app in a container, we'll use [AWS Fargate](https://aws.amazon.com/fargate/) with [Amazon ECS](https://aws.amazon.com/ecs/). Replace the `run` function in your `neo.config.ts`.
...
The `dev.command` tells NEO to instead run our Next.js app locally in dev mode.
...
<Image src={nextAppContainer} alt="NEO Next.js app local" />
...
# RUN --mount=type=secret,id=NEO_RESOURCE_MyResource,env=NEO_RESOURCE_MyResource \
#   npm run build
...
```dockerfile
RUN --mount=type=secret,id=NEO_RESOURCE_MyBucket,env=NEO_RESOURCE_MyBucket npm run build
```
...
<Image src={consoleAutodeploy} alt="NEO Console Autodeploy" />
