---
title: Nuxt on AWS with NEO
description: Create and deploy a Nuxt app to AWS with NEO.
---

There are two ways to deploy a Nuxt app to AWS with NEO.
...
:::tip[View source]
You can [view the source](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-nuxt) of this example in our repo.
:::
...
Run the following to start dev mode. This'll start NEO and your Nuxt app.
...
![NEO Nuxt app](../../../../../assets/docs/start/start-nuxt.png)
...
:::tip[View source]
You can [view the source](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-nuxt-container) of this example in our repo.
:::
...
To deploy our Nuxt app in a container, we'll use [AWS Fargate](https://aws.amazon.com/fargate/) with [Amazon ECS](https://aws.amazon.com/ecs/). Replace the `run` function in your `neo.config.ts`.
...
The `dev.command` tells NEO to instead run our Nuxt app locally in dev mode.
...
![NEO Nuxt container app](../../../../../assets/docs/start/start-nuxt-container.png)
