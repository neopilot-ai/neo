---
title: SolidStart on AWS with NEO
description: Create and deploy a SolidStart app to AWS with NEO.
---

There are two ways to deploy SolidStart apps to AWS with NEO.
...
:::tip[View source]
You can [view the source](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-solid) of this example in our repo.
:::
...
Run the following to start dev mode. This'll start NEO and your SolidStart app.
...
Let's allow public `access` to our S3 Bucket for file uploads. Update your `neo.config.ts`.
...
![NEO SolidStart app](../../../../../assets/docs/start/start-solidstart.png)
...
:::tip[View source]
You can [view the source](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-solid-container) of this example in our repo.
:::
...
To deploy our SolidStart app in a container, we'll use [AWS Fargate](https://aws.amazon.com/fargate/) with [Amazon ECS](https://aws.amazon.com/ecs/). Replace the `run` function in your `neo.config.ts`.
...
The `dev.command` tells NEO to instead run our SolidStart app locally in dev mode.

---

### 3. Add Redis

Let's add an [Amazon ElastiCache](https://aws.amazon.com/elasticache/) Redis cluster. Add this below the `Vpc` component in your `neo.config.ts`.
...
![NEO SolidStart container app](../../../../../assets/docs/start/start-solidstart-container.png)
