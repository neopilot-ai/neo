---
title: Remix on AWS with NEO
description: Create and deploy a Remix app to AWS with NEO.
---

There are two ways to deploy a Remix app to AWS with NEO.
...
:::tip[View source]
You can [view the source](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-remix) of this example in our repo.
:::
...
Run the following to start dev mode. This'll start NEO and your Remix app.
...
![NEO Remix app local](../../../../../assets/docs/start/start-remix-local.png)
...
:::tip[View source]
You can [view the source](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-remix-container) of this example in our repo.
:::
...
To deploy our Remix app in a container, we'll use [AWS Fargate](https://aws.amazon.com/fargate/) with [Amazon ECS](https://aws.amazon.com/ecs/). Replace the `run` function in your `neo.config.ts`.
...
The `dev.command` tells NEO to instead run our Remix app locally in dev mode.
...
![NEO Remix app local](../../../../../assets/docs/start/start-remix-local-container.png)
