---
title: Express on AWS with NEO
description: Create and deploy an Express app to AWS with NEO.
---

We are going to build an app with Express, add an S3 Bucket for file uploads, and deploy it to AWS in a container with NEO.

:::tip[View source]
You can [view the source](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-express) of this example in our repo.
:::
...
To deploy our Express app, let's add an [AWS Fargate](https://aws.amazon.com/fargate/) container with [Amazon ECS](https://aws.amazon.com/ecs/). Update your `neo.config.ts`.
...
Run the following to start dev mode. This'll start NEO and your Express app.
