---
title: Analog on AWS with NEO
description: Create and deploy an Analog app to AWS with NEO.
---

We are going to create an [Analog app](https://analogjs.org/), add an S3 Bucket for file uploads, and deploy it to AWS using NEO.

:::tip[View source]
You can [view the source](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-analog) of this example in our repo.
:::
...
Run the following to start dev mode. This'll start NEO and your Analog app.
