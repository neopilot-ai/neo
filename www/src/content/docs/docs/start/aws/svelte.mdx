---
title: SvelteKit on AWS with NEO
description: Create and deploy a SvelteKit app to AWS with NEO.
---

There are two ways to deploy a SvelteKit app to AWS with NEO.
...
:::tip[View source]
You can [view the source](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-svelte-kit) of this example in our repo.
:::
...
Run the following to start dev mode. This'll start NEO and your SvelteKit app.
...
![NEO SvelteKit app local](../../../../../assets/docs/start/start-svelte-kit-local.png)
...
:::tip[View source]
You can [view the source](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-svelte-container) of this example in our repo.
:::
...
To deploy our SvelteKit app in a container, we'll use [AWS Fargate](https://aws.amazon.com/fargate/) with [Amazon ECS](https://aws.amazon.com/ecs/). Replace the `run` function in your `neo.config.ts`.
...
The `dev.command` tells NEO to instead run our SvelteKit app locally in dev mode.
...
![NEO SvelteKit app local](../../../../../assets/docs/start/start-svelte-kit-local-container.png)
