---
title: React Router on AWS with NEO
description: Create and deploy a React Router v7 app to AWS with NEO.
---
...
:::tip[View source]
You can [view the source](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-react-router) of this example in our repo.
:::
...
Run the following to start dev mode. This'll start NEO and your React Router app.
...
![NEO React Router app local](../../../../../assets/docs/start/start-react-router-start-local.png)
