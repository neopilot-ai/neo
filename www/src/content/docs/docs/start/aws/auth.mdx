---
title: OpenAuth with NEO and Next.js
description: Add OpenAuth to your Next.js app and deploy it with NEO.
---
...
We are going to create a new Next.js app, add authentication to it with [OpenAuth](https://openauth.js.org), and deploy it with [OpenNext](https://opennext.js.org) and NEO.

:::tip[View source]
You can [view the source](https://github.com/neopilot-ai/neo/tree/dev/examples/aws-auth-nextjs) of this example in our repo.
:::
...
Now let's add this to our NEO app. Replace the `run` function in `neo.config.ts` with the following.
...
Run the following to start dev mode. This'll start NEO, your Next.js app, and your OpenAuth server.
...
If you check the **Functions** tab in your `neo dev` session, you'll see the code being console logged. You can use this code to login.
