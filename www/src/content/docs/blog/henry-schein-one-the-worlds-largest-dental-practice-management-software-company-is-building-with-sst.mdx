...
In this post we are talking to Jack Fraser, a Software Engineering Manager at [Henry Schein One](https://henryscheinone.com). They are using [NEO](/) and [Seed](https://seed.run) to power the patient booking experience and the management software used by thousands of dental practices globally.
...
This is around when they found NEO and it made perfect sense for them. _"It was based on CDK, and while CDK is great it is really verbose"_, says Jack.

> "CDK is great but it is really verbose"

The other aspect that they found really appealing was the Live Lambda Development environment. _"We loved the Live Lambda debugging in NEO"_.

> "We loved the Live Lambda debugging in NEO"

Now they have 15 stacks in their NEO app. With over 200 endpoints in their API. It also includes 4 Angular apps that use NEO's StaticSite construct.

They also decided to move to GraphQL to manage their APIs. _"We are already using NEO's ApolloApi construct"_, says Phil Astle, a Senior Software Engineer on the team.
...
Thanks to what NEO and Seed offers, they decided to _"make a big bet on NEO"_, says Jack. And they've gone all in on NEO.

> "We have gone all-in on NEO"
