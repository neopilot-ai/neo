...
If you haven't used Autodeploy before, we designed it to be a better fit for NEO apps when compared to alternatives like GitHub Actions or CircleCI.

1. **Easy to get started**, supports branch and PR workflow out of the box.
2. **Configurable**, customize your workflow through your `neo.config.ts`.
3. **Runs in your AWS account**, builds are run in your AWS account and can use your VPC.

And it integrates with the rest of the NEO Console. [Learn more about Autodeploy](/docs/console#autodeploy) to get started.
