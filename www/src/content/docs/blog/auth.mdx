...
template: splash
title: Auth
description: We are launching a modern lightweight authentication library for your NEO apps.
author: jay
pagefind: false
image: /social-cards/blog/neo-auth.png
lastUpdated: 2022-09-01
---

import { YouTube } from '@astro-community/astro-embed-youtube';

Today we are launching `Auth` — a modern lightweight authentication library for your NEO apps.

With a simple set of configuration, it'll create a function that'll handle various authentication flows. You can then attach this function to your API and NEO will help you manage the session tokens.
