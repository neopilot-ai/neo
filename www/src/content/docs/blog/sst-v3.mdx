...
Starting with the first big change, [ion.neo.dev](https://ion.neo.dev) is now just [neo.dev](https://neo.dev). You might've already noticed the new design.

The docs, [neo.dev/docs](/docs/) are also brand new. The API and reference docs are completely generated from code. This means that they're always up to date and you can view them inline in your code editor.
...
- **Guide**
  ...
  Our [NEO Guide](https://guide.neo.dev) has been updated to use v3. It teaches you how to build a full-stack app on AWS with NEO.
...
The NEO v2 docs have been moved to [v2.neo.dev](https://v2.neo.dev).
