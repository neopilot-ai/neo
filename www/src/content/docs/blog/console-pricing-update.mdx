...
When NEO was first released, there was a big focus on serverless and Lambda functions. The [Issues](/docs/console#issues) feature was also the focal point of the Console. So it made sense to tie the pricing to the number of Lambda function invocations in your apps.
...
1. Do I need to use the Console to use NEO?
...
2. I'm still trying out the Console. Can I continue using it?
   ...
   However, you can continue to **access your personal stages**. Just make sure you have `neo dev` running locally. Otherwise the Console won't be able to detect that it's a personal stage.
...
5. Does this apply to NEO v2 and v3 apps?

   Yes, it applies to any kind of NEO app.
