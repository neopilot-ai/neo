---
title: Buildforce & NEO
description: We are talking to Michael Orcutt, the founder of Buildforce about their experience building with NEO and Seed.
pagefind: false
author: jay
template: splash
...
We are talking to Michael Orcutt, a co-founder of [Buildforce](https://buildforce.com) about their experience building with [NEO](/) and [Seed](https://seed.run).
...
Around 2 months ago the team came together and decided they needed to make a change. They had heard about [NEO](/) and the NEO Guide. They decided they needed to take a deeper look.

As they tried out NEO, _"We were blown away by the local development environment"_, says Michael. The entire team decided to move to NEO.

> "We were blown away by the local development environment."

They decided to start a new NEO app from scratch. They spent some time testing NEO and within a month they had moved over completely. The new setup Michael says is _"Such a great experience. We are at least 1.5 to 2 times faster than before"_.
...
From an architecture perspective, their single web application will most likely be split into multiple NEO apps; one for their electricians, one for the contractors, and one for the ops team. They will also be introducing ElasticSearch for better search functionality.

Thanks to NEO their entire development setup works seamlessly, allowing them to focus on the needs of a fast growing business.
