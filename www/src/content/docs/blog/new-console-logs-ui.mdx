...
description: We've updated how you view your application logs in the NEO Console.
author: jay
...
import logsLight from '../../../assets/blog/neo-console-logs-light.png';
import logsDark from '../../../assets/blog/neo-console-logs-dark.png';

We recently updated the logs UI in the NEO Console. We've added the ability to **search**, view **log streams**, and just made it **faster**.

<picture>
  <source srcset={logsDark.src} media="(prefers-color-scheme: dark)" />
  <source srcset={logsLight.src} media="(prefers-color-scheme: light)" />
  <Image src={logsLight} alt="NEO Console Logs" />
</picture>
