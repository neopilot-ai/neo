...
func NewTestProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Test {
	...
	serviceURL += baseServicePath(pathPrefix, "github.com.neo.ion.test", "Test")
	urls := [1]string{
		serviceURL + "Echo",
	}
...
func (c *testProtobufClient) Echo(ctx context.Context, in *EchoRequest) (*EchoResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "github.com.neo.ion.test")
...
const TestPathPrefix = "/twirp/github.com.neo.ion.test.Test/"
...
func (s *testServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "github.com.neo.ion.test.Test" {
...
func (s *testServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "github.com.neo.ion.test", "Test")
}
