...
import (
	...
	"github.com/neopilot-ai/neo/v3/pkg/runtime/golang"
	"github.com/neopilot-ai/neo/v3/pkg/runtime/node"
	"github.com/neopilot-ai/neo/v3/pkg/runtime/python"
	"github.com/neopilot-ai/neo/v3/pkg/runtime/rust"
...
func Discover() (string, error) {
	...
	cfgPath, err := fs.FindUp(cwd, "neo.config.ts")
	if err != nil {
		return "", err
	}
...
func ResolveWorkingDir(cfgPath string) string {
	return filepath.Join(filepath.Dir(cfgPath), ".neo")
}
...
func (p Project) PathWorkingDir() string {
	return filepath.Join(p.root, ".neo")
}
