...
var CmdState = &cli.Command{
	...
	Children: []*cli.Command{
		...
		},
		{
			...
			Description: cli.Description{
				...
				Long: strings.Join([]string{
					...
					"",
					"```bash frame=\"none\"",
					"neo state export --stage production",
					"```",
					"",
		...
		{
			Name: "list",
			// TODO: Fix https://github.com/neopilot-ai/neo/issues/5566 before enabling
			Hidden: true,
			Description: cli.Description{
		...
		},
		{
			...
			Description: cli.Description{
				...
				Long: strings.Join([]string{
					...
					"",
					"```bash frame=\"none\"",
					"neo state remove MyBucket",
					"```",
					"",
					"Here, `MyBucket` is the name of the resource as defined in your `neo.config.ts`.",
					"",
					...
					"",
					"```bash frame=\"none\"",
					"neo state remove MyBucket --stage production",
					"```",
					"",
					"By default, it runs on your personal stage.",
				}, "\n"),
		...
		},
		{
			...
			Description: cli.Description{
				...
				Long: strings.Join([]string{
					...
					"edited, the state can become corrupted. This will cause your `neo deploy` command",
					"to fail.",
					"",
					...
					"",
					"```bash frame=\"none\"",
					"neo state repair --stage production",
					"```",
					"",
					"By default, it runs on your personal stage.",
				}, "\n"),
