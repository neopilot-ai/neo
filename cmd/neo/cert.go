...
var CmdCert = &cli.Command{
	...
	Description: cli.Description{
		...
		Long: strings.Join([]string{
			...
			"",
			"The Console can show you local logs from `neo dev` by connecting to your  CLI. Certain browsers like Safari and Brave require the local connection  to be running on HTTPS.",
			"",
