 ...
 * const base = new neo.aws.Function("PythonFn", {
 *   python: {
 *     container: true,
 *   },
 ...
 * ```
 *
 * Now when you run `neo deploy`, it uses a built-in Dockerfile to build the image
 ...
 * const custom = new neo.aws.Function("PythonFnCustom", {
 *   python: {
 *     container: true,
 *   },
 ...
 * # The python version to use is supplied as an arg from NEO
 ...
 * that `neo dev` uses the same version as `neo deploy`.
 */
