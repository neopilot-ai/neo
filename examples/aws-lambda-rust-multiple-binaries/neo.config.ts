 ...
 *
 * NEO relies on the work of [cargo lambda](https://cargo-lambda) to build and deploy Rust Lambda functions.
 *
 ...
 *
 * ```ts title="neo.config.ts" {5,11}
 * new neo.aws.Function("push", {
 *   url: true,
 *   runtime: "rust",
 *   link: [bucket],
 *   handler: "./.push",
 * });
 * new neo.aws.Function("pop", {
 *   url: true,
 *   runtime: "rust",
 *   link: [bucket],
 *   handler: "./.pop",
...
export default $config({
  ...
  async run() {
    ...
    const push = new neo.aws.Function("push", {
      runtime: "rust",
      handler: "./.push",
      url: true,
      architecture: "arm64",
    ...
    const pop = new neo.aws.Function("pop", {
      runtime: "rust",
      handler: "./.pop",
      url: true,
      architecture: "arm64",
