...
export interface ReactArgs extends SsrSiteArgs {
   ...
   *
   * :::note
   * In `neo dev` your React app is run in dev mode; it's not deployed.
   * :::
   *
  ...
  /**
   * Path to the directory where your React app is located.  This path is relative to your `neo.config.ts`.
   *
   * By default it assumes your React app is in the root of your NEO app.
   * @default `"."`
   *
   * @example
   *
   ...
   * 2. Locally while running `react-router dev` through `neo dev`.
   *
   * :::tip
...
const __pulumiType = "neo:aws:React";
// @ts-expect-error
