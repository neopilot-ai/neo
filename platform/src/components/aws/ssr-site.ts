...
export interface SsrSiteArgs extends BaseSsrSiteArgs {
   ...
   * default region of your NEO app.
   *
   * :::note
   ...
   * location.
   *
   * @default The default region of the NEO app
   *
   * @example
   * ```js
   * {
  ...
  return event.response;
    ...
    function createLambdaEdgeFunction() {
      return protection.apply((protectionConfig) => {
        ...
        // Create IAM role for Lambda@Edge using NEO transform pattern
        ...
        // Create the Lambda@Edge function using NEO transform pattern
