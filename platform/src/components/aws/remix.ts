...
export interface RemixArgs extends SsrSiteArgs {
   ...
   *
   * :::note
   * In `neo dev` your Remix app is run in dev mode; it's not deployed.
   * :::
   *
  ...
  /**
   * Path to the directory where your Remix app is located.  This path is relative to your `neo.config.ts`.
   *
   * By default it assumes your Remix app is in the root of your NEO app.
   * @default `"."`
   *
   * @example
   *
...
const __pulumiType = "neo:aws:Remix";
// @ts-expect-error
