 ...
 * new neo.aws.CognitoIdentityPool("MyIdentityPool", {
 *   userPools: [
 *     {
 *       userPool: "us-east-1_QY6Ly46JH",
 *       client: "6va5jg3cgtrd170sgokikjm5m6"
...
export class CognitoIdentityPool extends Component implements Link.Linkable {
   ...
   *   ? neo.aws.CognitoIdentityPool.get("MyIdentityPool", "us-east-1:02facf30-e2f3-49ec-9e79-c55187415cf8")
   *   : new neo.aws.CognitoIdentityPool("MyIdentityPool");
   * ```
   *
...
const __pulumiType = "neo:aws:CognitoIdentityPool";
// @ts-expect-error
