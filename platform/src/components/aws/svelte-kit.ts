...
export interface SvelteKitArgs extends SsrSiteArgs {
   ...
   *
   * :::note
   * In `neo dev` your SvelteKit app is run in dev mode; it's not deployed.
   * :::
   *
  ...
  /**
   * Path to the directory where your SvelteKit app is located.  This path is relative to your `neo.config.ts`.
   *
   * By default it assumes your SvelteKit app is in the root of your NEO app.
   * @default `"."`
   *
   * @example
   *
    ...
    return outputPath.apply((outputPath) => {
      ...
      return {
        ...
        server: {
          ...
          nodejs: {
            esbuild: {
              minify: process.env.NEO_DEBUG ? false : true,
              sourcemap: process.env.NEO_DEBUG ? ("inline" as const) : false,
              define: {
                "process.env.NEO_DEBUG": process.env.NEO_DEBUG
                  ? "true"
                  : "false",
              },
            },
        ...
        assets: [
          {
            from: path.join(".svelte-kit", "svelte-kit-neo", "client"),
            to: "",
            cached: true,
          ...
          {
            from: path.join(".svelte-kit", "svelte-kit-neo", "prerendered"),
            to: "",
            cached: false,
          },
        ],
...
const __pulumiType = "neo:aws:SvelteKit";
// @ts-expect-error
