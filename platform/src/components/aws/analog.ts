...
export interface AnalogArgs extends SsrSiteArgs {
   ...
   *
   * :::note
   * In `neo dev` your Analog app is run in dev mode; it's not deployed.
   * :::
   *
  ...
  /**
   * Path to the directory where your Analog app is located.  This path is relative to your `neo.config.ts`.
   *
   * By default it assumes your Analog app is in the root of your NEO app.
   * @default `"."`
   *
   * @example
   *
   ...
   * 2. Locally while running `neo dev ng serve`.
   *
   * :::tip
...
const __pulumiType = "neo:aws:Analog";
// @ts-expect-error
