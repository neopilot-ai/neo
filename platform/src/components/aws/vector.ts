 ...
 * const vector = new neo.aws.Vector("MyVectorDB", {
 *   dimension: 1536
 * });
 * ```
 *
...
export class Vector extends Component implements Link.Linkable {
   ...
   *   ? neo.aws.Vector.get("MyVectorDB", "app-dev-myvectordb")
   *   : new neo.aws.Vector("MyVectorDB", {
   *       dimension: 1536
   *     });
   * ```
   *
...
const __pulumiType = "neo:aws:Vector";
// @ts-expect-error
