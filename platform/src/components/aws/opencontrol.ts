 ...
 * const server = new neo.aws.OpenControl("MyServer", {
 *   server: "src/server.handler"
 * });
 * ```
 *
 ...
 * const anthropicKey = new neo.Secret("AnthropicKey");
 *
 * const server = new neo.aws.OpenControl("MyServer", {
 *   server: {
 *     handler: "src/server.handler",
 ...
 *
 * new neo.aws.OpenControl("MyServer", {
 *   server: {
 *     handler: "src/server.handler",
 *     link: [bucket]
 *   }
 ...
 * new neo.aws.OpenControl("OpenControl", {
 *   server: {
 *     handler: "src/server.handler",
 *     policies: $dev
...
const __pulumiType = "neo:aws:OpenControl";
// @ts-expect-error
