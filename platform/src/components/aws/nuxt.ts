...
export interface NuxtArgs extends SsrSiteArgs {
   ...
   *
   * :::note
   * In `neo dev` your Nuxt app is run in dev mode; it's not deployed.
   * :::
   *
  ...
  /**
   * Path to the directory where your Nuxt app is located.  This path is relative to your `neo.config.ts`.
   *
   * By default it assumes your Nuxt app is in the root of your NEO app.
   * @default `"."`
   *
   * @example
   *
...
const __pulumiType = "neo:aws:Nuxt";
// @ts-expect-error
