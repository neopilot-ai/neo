...
export interface WorkerArgs {
   ...
   *
   * The handler path is relative to the root your repo or the `neo.config.ts`.
   *
   * @example
   *
   * ```js
   ...
   *
   * NEO bundles your worker code using [esbuild](https://esbuild.github.io/). This tree shakes your code to only include what's used.
   */
  build?: Input<{
    /**
 ...
 * new neo.cloudflare.Worker("MyWorker", {
 ...
 * #### Bundling
 *
 * Customize how NEO uses [esbuild](https://esbuild.github.io/) to bundle your worker code with the `build` property.
 *
...
const __pulumiType = "neo:cloudflare:Worker";
// @ts-expect-error
