...
export interface BaseStaticSiteArgs {
   ...
   *
   * 1. Locally while running your site through `neo dev`.
  ...
  vite?: Input<{
     ...
     *
     * @default `"src/neo-env.d.ts"`
     * @example
     * ```js
     * {
     *   vite: {
     *     types: "other/path/neo-env.d.ts"
     *   }
     * }
     * ```
     */
  ...
  function generateViteTypes() {
    return all([sitePath, args.vite, environment]).apply(
      ([sitePath, vite, environment]) => {
        ...
        const content = `/* This file is auto-generated by NEO. Do not edit. */
/* tslint:disable */
/* eslint-disable */
