    ...
    context = {
      ...
      callbackWaitsForEmptyEventLoop: {
        set value(_value: boolean) {
          throw new Error(
            "`callbackWaitsForEmptyEventLoop` on lambda Context is not implemented by NEO Live Lambda Development.",
          );
        },
        get value() {
          return true;
        ...
        throw new Error(
          "`done` on lambda Context is not implemented by NEO Live Lambda Development.",
        );
      },
      fail() {
        throw new Error(
          "`fail` on lambda Context is not implemented by NEO Live Lambda Development.",
        );
      },
      succeed() {
        throw new Error(
          "`succeed` on lambda Context is not implemented by NEO Live Lambda Development.",
        );
      },
    };
