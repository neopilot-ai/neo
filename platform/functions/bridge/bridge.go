...
var NEO_FUNCTION_ID = os.Getenv("NEO_FUNCTION_ID")
var NEO_FUNCTION_TIMEOUT = os.Getenv("NEO_FUNCTION_TIMEOUT")
var NEO_REGION = os.Getenv("NEO_REGION")
var NEO_ASSET_BUCKET = os.Getenv("NEO_ASSET_BUCKET")
...
var ENV_BLACKLIST = map[string]bool{
	"NEO_DEBUG_ENDPOINT":              true,
	"NEO_DEBUG_SRC_HANDLER":           true,
	"NEO_DEBUG_SRC_PATH":              true,
...
func run() error {
	...
	notRunning, _ := json.Marshal(map[string]string{
		"statusCode": "500",
		"body":       "neo dev is not running (worker: " + workerID + ")",
	})
